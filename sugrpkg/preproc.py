...
def add_time_periodicity(df: pd.DataFrame) -> NoReturn:
    """ Add x(t) and y(t) defined as cosine and 
    sine of the minutes of the day. 
    These there are 1440 minutes in a day, 
    so the period T is set to 1439 (because we start at 0)
    """
